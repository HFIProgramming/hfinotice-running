...
<body>
    ...
    <div id="content">
        ...
        <div id="notice">
            <p id="notice_title"><img src="../../../images/emergency.png" id="figure">Image upload success!</p>
            </div>
            
            <div id="upload_area">
                <p>Now copy the code shown below and use it to represent your picture in the notification postbox.</p>
                <textarea id="image_code" rows="7"><?=$link?></textarea>
                <div id="upload_more" onClick="location.href='http://hfinotice.sinaapp.com/notification/upload_image_page'">Click to upload more Images!</div>
            </div>
