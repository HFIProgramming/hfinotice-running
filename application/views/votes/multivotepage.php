    	...
    	<div class="place_holder"></div>
         ...
         <div class="vote_content_bag">
            ...
            <div id="vote_options">
        		...
        		<p>
                    <input type="checkbox" id="option_id_<?=$row->id?>" class="regular-checkbox" onClick="do_2_vote(this.id)">
                    <label for="option_id_<?=$row->id?>"></label>
                    <span class="vote_option_list"><?=$row->title?></span>
                </p>
                <?php endforeach;?>
        	</div>
            
            <?php 
            $attr=array('id'=>'multi_form');
            echo form_open('votes/do_2_votes',$attr);
    		?>
            <input type="hidden" value="" id="option_choice_1" name="choice1">
            <input type="hidden" value="" id="option_choice_2" name="choice2">
            <input type="hidden" value="<?=$vote_id?>" name="voteid">
            <input type="submit" id="vote_submit" value="VOTE">
            </form>
        </div>
