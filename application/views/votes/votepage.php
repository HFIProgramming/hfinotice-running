    	...
    	<div class="place_holder"></div>
         ...
         <div class="vote_content_bag">
            ...
            <div id="vote_options">
        		...
        		<p>
                	<input type="radio" id="option_id_<?=$row->id?>" name="field" class="regular-radio" onClick="do_vote(this.id)"/>
            ...
            <?php 
            $attr=array('id'=>'vote_form');
            echo form_open('votes/do_votes',$attr);
    		?>
            <input type="hidden" value="" id="option_choice" name="choice">
