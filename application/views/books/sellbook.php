		...
		<div class="content-grid small-10 medium-8 large-6 small-push-1 medium-push-2 large-push-3">
			<?php
				$attr=array('id'=>'verify');
			 	echo form_open('books/submit',$attr); 
			 ?>
				
                <div class="small-10 small-push-1 input-unit">
                	<span>你的标题(包含卖书人信息以及书名):</span>
					<input type="text" id="color-picker" name="title" placeholder="你卖书的标题">
				</div>
				...
				<div class="small-10 small-push-1 input-unit">
					<textarea name="content" rows="10" id="post_content"></textarea>
				</div>
