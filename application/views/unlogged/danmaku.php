	...
	<body id="body">
		...
		<div class="title-bar main-bar">
			<div class="title-bar-left main-ham">
				<div class="button-container">
					...
					<a href="http://hfinotice.sinaapp.com"
					   style="display:block; font-size: 1.62rem; margin-top: 0.25rem; margin-left: 0.75rem"><i
				...
				<div class="dropdown-pane bottom" id="reminder-dropdown" data-dropdown data-hover="true"
				     data-hover-pane="true" style="display: none">
					<!--one reminder-->
		...
		<div class="reveal" id="sign-in" style="display:none;" data-reveal>
			...
			<form data-abide novalidate>
				...
				<div class="row">
					<div class="small-12 columns">
						<label>Username
							<input type="text" id="username-input" placeholder="Conoha Concordia"
							       aria-describedby="usernameHelpText" required>
          ...
          Please enter your username.
					...
					<div class="small-12 columns">
						<label>Password
							<input type="password" id="password-input" placeholder="yeti4preZ"
          ...
          Please enter your password.
				...
				<div class="row">
					...
					<fieldset class="small-6 columns" style="text-align: right;">
						<button class="button alert" onClick="location.href='resetpassword'" style="margin-right: 0;">
							Reset Password
						</button>
					</fieldset>
				</div>
		...
		<div id="information-block" class="row">
			<div class="large-8 large-push-2 medium-10 medium-push-1 columns">
				<div id="Danmaku-post" class="media-object post-card">
					<p style="margin-top: -0.75rem"><a href="http://hfinotice.sinaapp.com">Log in</a> to send coloured
						comments.</br>
						请<a href="http://hfinotice.sinaapp.com">登录</a>以发送彩色弹幕。</p>
					...
					<input class="button" style="float: right; margin-right: -0.0625rem; margin-top: 0.25rem;"
					       type="submit" size="100" value="Send">
					</form>
